...
namespace MalachiTemp.UI
{
    ...
    */
    ...
    {
        public static string MenuTitle = "TTT41 Template Test"; // this is the menu name, you can change it to whatever you want
        ...
        public static List<ButtonInfo> CatButtons1 = new List<ButtonInfo>
        {
            ...
            new ButtonInfo { buttonText = "No clip 2", method =() => Mods.Noclip2(), enabled = false, toolTip = "test mod"},
        };
        #endregion
        #region Category 2
        public static List<ButtonInfo> CatButtons2 = new List<ButtonInfo>
        {
            ...
            new ButtonInfo { buttonText = "Noclip2", method =() => Mods.Noclip2(), enabled = false, toolTip = "test test!"},
            new ButtonInfo { buttonText = "carmonke", method =() => Mods.carmonke(), enabled = false, toolTip = "Move the right jositig!"},
            new ButtonInfo { buttonText = "LongArms", method =() => Mods.LongArms(), enabled = false, toolTip = "you will get longarms warnig!"},
            new ButtonInfo { buttonText = "Speed Boost", method =() => Mods.SpeedBoost(), enabled = false, toolTip = "are gonr un fast just be craful!"},
        };
        #endregion
        #region Category 3
        ...
        {
            "Welcome to the TTT41 menu", // motd title
            "Welcome to ttt41 menu", // coc title
            "this menu is in beta test so dont komplain about the menu is only has 10 page but in the first page it has lot of mod menu", // coc description
            "this mod menu is new and its beta test and thanks for using this mod menu" // motd description
        };
        public static string FolderName = "TTT41_Temp"; // this is the name for the folder that holds ur saved settings and buttons and other stuff
        #endregion 
        #region Colors
        ...
        public static Color NormalColor = Color.blue; // if changingcolors is false, this is the main color that menu will be
        public static Color ButtonColorDisable = Color.green; // this is the main color of the buttons when they r disabled
